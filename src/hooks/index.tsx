...
export const useChainPriceFeed = (chain: Chain | undefined) => {
  ...
  const [feedAddress, setFeedAddress] = useState<Address | undefined>(undefined)
...
export const useIsBalanceSufficientToCoverGas = () => {
  ...
  const isNativeToken = chain?.nativeCurrency.symbol === token?.tokenInfo.symbol
...
export const useDynamicLoadingLabel = ({
  ...
  const combinedLabels = shouldFallback ? labels.concat(DEFAULT_LABELS) : labels
